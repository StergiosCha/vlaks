...
export const EXTRA_EVENTS: ExtraEvent[] = [
  ...
  },
  {
    ...
    evidence: [
      'FB ποστ Αλέξανδρου Χατζή, 20/08/2018, στο Fuit art cafe, μαζί με τον τιμώμενο.',
  ...
  },
  {
    ...
    evidence: ['FB ποστ 02/04/2025. Πλήρες απόσπασμα: σελίδα «Οι Βλάκες», ράφι «σοβαρά τώρα».'],
    sources: [],
  },
  {
    id: 'per-istories',
